...
@section('content')
    ...
    <section class="w-full h-64 bg-red-700">
        <div class="max-w-screen-xl mx-auto p-10 md:px-0 md:py-5">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-10">
                <div class="w-full p-6 bg-white border border-gray-200 rounded-sm shadow">
                    ...
                    <a href="javascript:void(0)"
                        class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-sm hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                        Read more
